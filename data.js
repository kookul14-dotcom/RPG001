...
export const CLASS_DATA = {
    ...
    // 몬스터 (maxXp를 0에서 9999로 수정하여 버그 방지)
    'SLIME': { name: '슬라임', atkType: 'PHYS', element: 'WATER', level: 1, xp: 0, maxXp: 9999, hp: 300, mp: 50, spd: 5, mov: 2, rng: 1, str: 15, int: 0, vit: 40, agi: 2, def: 10, dex: 0, icon: '🟢', skills: [{id:'m1', name:'점액', mp:0, rng:1, cool:0, main:{type:'DMG', target:'ENEMY_SINGLE', mult:1, dmgType:'PHYS'}, sub:{type:'SPD_DOWN', target:'ENEMY_SINGLE', mult:0.5, duration:2}}]},
    'GOBLIN': { name: '고블린', atkType: 'PHYS', element: 'WIND', level: 1, xp: 0, maxXp: 9999, hp: 180, mp: 30, spd: 14, mov: 4, rng: 1, str: 20, int: 0, vit: 10, agi: 20, def: 5, dex: 15, icon: '👺', skills: [{id:'m2', name:'베기', mp:10, rng:1, cool:0, main:{type:'DMG', target:'ENEMY_SINGLE', mult:1.2, dmgType:'PHYS'}, sub:{type:'BLEED', target:'ENEMY_SINGLE', mult:0.2, duration:3}}]},
    'ORC': { name: '오크', atkType: 'PHYS', element: 'EARTH', level: 2, xp: 0, maxXp: 9999, hp: 500, mp: 20, spd: 7, mov: 3, rng: 1, str: 35, int: 0, vit: 30, agi: 5, def: 25, dex: 5, icon: '👹', skills: [{id:'m3', name:'강타', mp:20, rng:1, cool:3, main:{type:'DMG', target:'ENEMY_SINGLE', mult:1.8, dmgType:'PHYS'}, sub:{type:'STUN', target:'ENEMY_SINGLE', duration:1}}]},
    'SKELETON': { name: '스켈레톤', atkType: 'PHYS', element: 'DARK', level: 1, xp: 0, maxXp: 9999, hp: 150, mp: 0, spd: 12, mov: 3, rng: 3, str: 25, int: 0, vit: 5, agi: 15, def: 5, dex: 10, icon: '☠️', skills: [{id:'m4', name:'뼈던지기', mp:0, rng:3, cool:0, main:{type:'DMG', target:'ENEMY_SINGLE', mult:1, dmgType:'PHYS'}}]},
    'DRAKE': { name: '드레이크', atkType: 'MAG', element: 'FIRE', level: 5, xp: 0, maxXp: 9999, hp: 800, mp: 200, spd: 9, mov: 3, rng: 3, str: 45, int: 30, vit: 50, agi: 8, def: 30, dex: 10, icon: '🐉', skills: [{id:'m5', name:'브레스', mp:50, rng:5, cool:4, main:{type:'DMG', target:'LINE', mult:1.5, dmgType:'MAG'}, sub:{type:'BURN', target:'LINE', mult:0.2, duration:3}}]},
    'LICH': { name: '리치', atkType: 'MAG', element: 'DARK', level: 5, xp: 0, maxXp: 9999, hp: 350, mp: 500, spd: 10, mov: 2, rng: 4, str: 10, int: 50, vit: 20, agi: 10, def: 10, dex: 5, icon: '💀', skills: [{id:'m6', name:'죽음', mp:40, rng:5, cool:2, main:{type:'DMG', target:'ENEMY_SINGLE', mult:1.5, dmgType:'MAG'}, sub:{type:'SILENCE', target:'ENEMY_SINGLE', duration:2}}]},
    'GOLEM': { name: '골렘', atkType: 'PHYS', element: 'EARTH', level: 4, xp: 0, maxXp: 9999, hp: 1000, mp: 0, spd: 4, mov: 2, rng: 1, str: 40, int: 0, vit: 60, agi: 1, def: 80, dex: 0, icon: '🗿', skills: [{id:'m7', name:'쿵', mp:0, rng:0, cool:5, main:{type:'STUN', target:'AREA_ENEMY', area:1, duration:1}}]},
    'SUCCUBUS': { name: '서큐버스', atkType: 'MAG', element: 'DARK', level: 3, xp: 0, maxXp: 9999, hp: 300, mp: 200, spd: 13, mov: 4, rng: 2, str: 20, int: 40, vit: 15, agi: 25, def: 10, dex: 20, icon: '😈', skills: [{id:'m8', name:'유혹', mp:40, rng:4, cool:4, main:{type:'SLEEP', target:'ENEMY_SINGLE', duration:2}, sub:{type:'DRAIN', target:'SELF', mult:1.0, dmgType:'MAG'}}]}
};
